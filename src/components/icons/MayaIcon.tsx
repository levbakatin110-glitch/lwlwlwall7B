...
const paths: Record<IconName, ReactNode> = {
  ...
  poop: (
    <>
      <path d="M7 16.6c0 2.6 2.2 4.2 5 4.2s5-1.6 5-4.2c0-1.5-.8-2.5-1.8-3.3" />
      <path d="M8.4 13.6c-1.1-1.1-.7-3 .8-3.6 1.3-.5 2.3.3 2.7 1.2.4-1.7 2.4-2.5 3.8-1.3 1.1 1 .8 2.5-.2 3.3" />
      <path d="M12.6 8.6c.2-1.5 1.5-2.5 2.8-2.1" />
      <circle cx="10.2" cy="15.2" r="0.55" fill="currentColor" stroke="none" />
      <circle cx="13.6" cy="15.2" r="0.55" fill="currentColor" stroke="none" />
      <path d="M10.5 17c.7.5 1.8.5 2.6 0" />
    </>
  ),
  check: (
    <>
