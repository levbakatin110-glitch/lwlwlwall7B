...
const paths: Record<IconName, ReactNode> = {
  ...
  feeding: (
    <>
      ...
      <path d="M7.2 19c.7-3.6 2.6-5.4 4.8-5.4s4.1 1.8 4.8 5.4" />
      <path d="M8.6 12.4 7.2 14.8M15.4 12.4 16.8 14.8" />
    </>
  ),
  formula: (
    <>
      <path d="M10 3.5h4v2.2l1.2 1.6V9H8.8V7.3L10 5.7V3.5Z" />
      <path d="M8.8 9h6.4v9.2a2 2 0 0 1-2 2h-2.4a2 2 0 0 1-2-2V9Z" />
      <path d="M10.6 12.2h2.8M10.6 15.2h2.8" />
    </>
  ),
  solids: (
    <>
  ...
  vaccines: (
    <>
      ...
      <path d="M13.7 5.8 18.2 10.3" />
      <path d="M16 8.6 8.4 16.2a2 2 0 0 1-2.8 0l-.6-.6a2 2 0 0 1 0-2.8L12.6 5.8" />
      <path d="M5 19l2.2-2.2" />
      <path d="M9.2 12.2h3.2" />
    </>
  ),
  health: (
    <>
  ...
  walk: (
    <>
      <path d="M5.5 7.5h3.2" />
      <path d="M7.1 7.5v8.6" />
      <path d="M8.8 10.2h8.4c.6 0 1 .5.9 1.1l-1.4 5.4H10L8.8 10.2Z" />
      <path d="M10.4 10.2V7.8a3.2 3.2 0 0 1 5.8 0v2.4" />
      <circle cx="10.2" cy="18.4" r="1.9" />
