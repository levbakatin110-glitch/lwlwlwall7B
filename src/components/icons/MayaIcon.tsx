...
const paths: Record<IconName, ReactNode> = {
  ...
  poop: (
    <>
      <path d="M13.8 2.85C16.55 2.55 17.9 4.95 16.15 6.6C18.5 7.5 20.05 10.15 19.35 12.55C18.95 13.75 17.75 14.55 16.35 14.95C19.45 15.75 21.15 17.65 20.75 19.85C20.35 22.05 16.55 23.05 12 23.05C7.45 23.05 3.65 22.05 3.25 19.85C2.85 17.65 4.55 15.75 7.65 14.95C6.25 14.55 5.05 13.75 4.65 12.55C4.05 10.15 5.6 7.5 8.0 6.6C6.35 4.85 8.0 2.7 11.0 2.95C11.85 2.85 12.75 2.85 13.8 2.85Z" />
      <path d="M14.35 3.35C16.15 2.15 18.15 3.55 17.15 5.45" />
      <path d="M7.85 15.05C9.7 13.7 14.3 13.7 16.15 15.05" />
      <path d="M8.85 9.35C10.3 8.15 13.7 8.15 15.2 9.45" />
      <circle cx="9.2" cy="19.15" r="1.25" fill="currentColor" stroke="none" />
      <circle cx="14.8" cy="19.15" r="1.25" fill="currentColor" stroke="none" />
      <path d="M9.45 21C11.05 22.25 12.95 22.25 14.55 21" />
    </>
  ),
  check: (
    <>
