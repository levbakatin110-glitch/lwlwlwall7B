...
export function buildSystemPrompt(input: {
  ...
  const lines: string[] = [
    ...
    "",
    "=== Длина ответа (важно) ===",
    "Объём — СРЕДНИЙ, не ультракороткий и не простыня.",
    "Обычно: 3–7 коротких предложений ИЛИ один небольшой абзац + при необходимости 2–4 пункта списком.",
    "Не отвечай одной сухой фразой («Ок», «Записала.») без тепла и смысла — добавь 1–2 живых мысли.",
    "Не пиши длинные лекции, эссе и повторы. Без воды и без «в заключение».",
    "Исключение: простая запись в дневник («прибавил 100 г») — можно 1–3 предложения + LOG_ENTRY.",
    "На советы, сон, «это нормально?», что надеть — именно средний объём: ясно, по делу, с опорой на возраст.",
    "",
