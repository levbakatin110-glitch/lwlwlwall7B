...
export function breastfeedingInsight(
  ...
  return {
    ...
    insight: {
      ...
      detail:
        "Ещё несколько кормлений с таймером — посчитаю обычный интервал именно у вас.",
    },
  };
}
...
export function waterInsight(
  ...
  return {
    ...
    insight: {
      ...
      detail: `Сегодня ${todayMl} мл. При ГВ жажда сильнее — график помогает не забывать стакан.`,
    },
  };
}
