...
const PITCHES: Record<ValueAudience, ValuePitch> = {
  pregnancy: pack(
    "Привет. Я Мая. Буду рядом на ваших неделях, без осуждения.",
  ...
  baby: pack(
    "Привет. Я Мая. Помню возраст малыша, сон и кормления.",
    "Чат с Маей по возрасту вашего малыша",
    [
      {
        icon: "chat",
        chip: "Чат",
        text: "Чат с Маей про режим, прикорм и скачки роста по возрасту малыша",
      },
      {
        icon: "sleep",
        chip: "Сон",
  ...
  general: pack(
    "Привет. Я Мая. Дневники и чат в одном месте.",
