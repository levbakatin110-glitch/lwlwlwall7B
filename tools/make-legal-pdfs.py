...
docs = [
    (
        ...
        [
            ...
            "",
            "ПРЕДМЕТ И ОПЛАТА",
            "Предмет — доступ к Maya Premium на оплаченный срок. Оплата через Prodamus. Цена — на странице /pricing (ориентир 349 руб./мес). Услуга считается оказанной с активации Premium.",
            "",
            "ВОЗВРАТ",
